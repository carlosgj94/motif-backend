...
pub struct ContentRecord {
    ...
    pub parser_quality_score: Option<i32>,
    pub parser_recovery: Option<Value>,
    pub parser_recovery_status: Option<String>,
    pub parser_recovery_stage: Option<String>,
    pub parser_recovery_requested_at: Option<OffsetDateTime>,
    pub parser_recovery_attempt_count: Option<i32>,
    pub parser_recovery_last_attempt_at: Option<OffsetDateTime>,
    pub parser_recovery_completed_at: Option<OffsetDateTime>,
    pub parser_recovery_last_error: Option<String>,
